 ...
 */
public class AllowedTabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         ...
         */
        View x = inflater.inflate(R.layout.tab_allow_layout, null);
        tabLayout = (TabLayout) x.findViewById(R.id.tabsAllow);
        viewPager = (ViewPager) x.findViewById(R.id.viewpagerAllow);
